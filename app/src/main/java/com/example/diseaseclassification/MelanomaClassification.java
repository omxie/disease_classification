...
public class MelanomaClassification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_melanoma_classification);

        takepicture = (Button) findViewById(R.id.mclassify);
